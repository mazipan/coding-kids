...
const en: Translations = {
  ...
  'landing.features.worlds.title': 'Two Learning Paths',
  'landing.features.worlds.desc': 'Block coding across 10 themed worlds, or 110+ brain training puzzles across 11 worlds — pick your path!',
  ...
  'landing.how.step1.title': 'Choose Your Path',
  'landing.how.step1.desc': 'Pick block coding or brain training, then choose a themed world — each one teaches a different concept.',
  ...
  'landing.worlds.title': 'Two Paths to Learning',
  'landing.worlds.sub': '10 themed coding worlds and 11 brain training worlds — grow from sequences to algorithms, and from pattern recognition to deductive reasoning.',
...
const id: Translations = {
  ...
  'landing.features.worlds.icon': '🌍',
  'landing.features.worlds.title': 'Dua Jalur Belajar',
  'landing.features.worlds.desc': 'Coding blok di 10 dunia bertema, atau 110+ teka-teki latihan otak di 11 dunia — pilih jalurmu!',
  'landing.features.anywhere.icon': '📱',
  ...
  'landing.how.step1.title': 'Pilih Jalurmu',
  'landing.how.step1.desc': 'Pilih coding blok atau latihan otak, lalu pilih dunia bertema — masing-masing mengajarkan konsep yang berbeda.',
  ...
  'landing.worlds.title': 'Dua Jalur Belajar',
  'landing.worlds.sub': '10 dunia coding bertema dan 11 dunia latihan otak — dari urutan ke algoritma, dan dari pengenalan pola ke penalaran deduktif.',
