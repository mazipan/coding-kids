          ...
          {worldLessons.map((lesson, idx) => {
            ...
            return (
              ...
              >
                ...
                {!unlocked && (
                  <div className="text-xs text-white/30 shrink-0">{t('common.locked')}</div>
                )}
              </motion.button>
            )
          })}
            ...
            >
              ...
              {unlocked ? (
                <div className="space-y-2">
                  ...
                  <div className="mt-3 bg-white/10 hover:bg-white/20 text-white font-bold text-xs px-4 py-2 rounded-xl transition-colors">
