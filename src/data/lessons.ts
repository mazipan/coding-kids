...
export const LESSONS: Lesson[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    number: 1,
    title: 'First Steps',
    story: 'Bingo the monkey just woke up and spotted a yummy banana nearby. It\'s only one step away!',
    mascotMessage: "Hi! I'm Bingo! 🐒 I see a banana! Use the ➡️ Move Right block to help me get it!",
    gridRows: 5,
    gridCols: 5,
    cells: emptyGrid(5, 5),
    startPos: [2, 0],
    ...
    hints: [
      ...
      "You only need ONE block. Try ➡️ Move Right and click Run!",
    ],
    starThresholds: [2, 1],
  },
  {
